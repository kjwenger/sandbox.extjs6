...
folder are mapped to the application's root namespace, 'sandbox.extjs6'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'sandbox.extjs6' in the same way
as `"sandbox.extjs6/sass/src"`.
